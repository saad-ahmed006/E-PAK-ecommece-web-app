...
export default function Modal({ buyNowData, setBuyNowData, handleBuyNowData,buyNow }) {
    ...
    <>
      <div className="  text-center rounded-lg text-white font-bold">
        <button
          type="button"
          onClick={openModal}
          className="w-full  bg-[#FCC50B] py-2 text-center rounded-lg text-white font-bold "
        >
          Buy Now
        </button>
      </div>
                          ...
                          <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(event) => handleBuyNowData(event)}
